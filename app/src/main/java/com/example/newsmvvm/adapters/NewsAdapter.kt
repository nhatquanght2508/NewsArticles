...
import com.example.newsmvvm.databinding.ItemArticlePreviewBinding
...
class NewsAdapter : RecyclerView.Adapter<NewsAdapter.ArticleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ArticleViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            setOnClickListener {
                onItemClickArticle?.let { it(article) }
            }
        }
    }
    ...
    private var onItemClickArticle: ((Article) -> Unit)? = null

    fun setOnItemClickArticle(listener: (Article) -> Unit) {
        onItemClickArticle = listener
    }
}